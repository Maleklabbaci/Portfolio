      ...
      <div className="relative z-10 container mx-auto px-4 text-center mt-20">
        ...
        <div className="flex flex-col items-center gap-6 animate-fade-in" style={{animationDelay: '0.2s'}}>
          ...
          <div className="flex gap-4 mt-4">
            <a href="#work" className="bg-brand-black text-white px-8 py-3 rounded-full font-bold hover:bg-brand-accent transition-colors shadow-lg">
              Voir les travaux
            </a>
            <a href="#contact" className="bg-white text-brand-black border border-gray-200 px-8 py-3 rounded-full font-bold hover:border-brand-black transition-colors">
              Contact
            </a>
          </div>
        </div>
