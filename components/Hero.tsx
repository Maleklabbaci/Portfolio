...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-[85vh] flex flex-col items-center justify-center overflow-hidden bg-white">
      ...
      {/* Content - Removed animate-fade-in for instant display */}
      <div className="relative z-10 container mx-auto px-4 text-center mt-20">
        <h1 className="text-7xl md:text-[10rem] font-black text-brand-black tracking-tighter leading-none mb-6 select-none">
